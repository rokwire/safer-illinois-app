...
class Covid19OnBoardingLoginPhonePanel extends StatefulWidget {
  @override
  _Covid19OnBoardingLoginPhonePanelState createState() => _Covid19OnBoardingLoginPhonePanelState();
}

class _Covid19OnBoardingLoginPhonePanelState extends State<Covid19OnBoardingLoginPhonePanel> implements NotificationsListener{
  ...
  void _onSkipTapped() {
    ...
    Navigator.push(context, CupertinoPageRoute(builder: (context)=>Covid19OnBoardingFinalPanel()));// Not logged in so skip qrcode panel
  }
    ...
    if (mounted) {
      if (success) {
        FlexUI().update().then((_){
          ...
          Analytics.instance.logSelect(target: 'Phone Logged In');
