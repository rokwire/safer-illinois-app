...
class _SettingsQrCodePanelState extends State<SettingsQrCodePanel> {
  ...
  void _loadQrImageBytes() {
    ...
    _userPrivateKeyString = (privateKeyData != null) ? base64.encode(privateKeyCompressedData) : null;
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(padding: EdgeInsets.only(top: 24), child:
                  (AppString.isStringNotEmpty(_userPrivateKeyString) ?
                    Semantics(label: Localization().getStringEx("panel.health.covid19.qr_code.primary.heading.title", "Your COVID-19 Encryption Key"), excludeSemantics: true, image: true, child:
                      Container(
                        ...
                        padding: EdgeInsets.all(5), child:
                          Container(
                            constraints: BoxConstraints(maxHeight: 1100, maxWidth: 1100),
                            height: 1100,
                            width: 1100,
                            child: QrImage(
